...
@Entity @Table(name="produto") public class Produto implements Serializable {
	...
	@OneToMany (mappedBy="id.produto") private Set<ItensPedido> itens = new HashSet<>();
	...
	@JsonIgnore public Set<Pedido> getPedidos() {
